const daphne = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/daphne.png'],
...
const fantasy = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/fantasy.png'],
...
const amphora = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/amphora.png'],
...
const josephine = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/josephine.png'],
...
const poetry = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/poetry.png'],
...
const innocence = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/innocence.png'],
...
const sparkle = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/sparkle.png'],
...
const ginebra = {
    ...
    currency: 'USD',
    inStock: true,
    images: ['img/new-in-shop/ginebra.png'],
